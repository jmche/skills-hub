...
- **Claude API & General:** https://platform.claude.com/llms.txt
...
- Docs Map: https://platform.claude.com/llms.txt
...
- Enterprise Sales: https://claude.com/contact-sales

> URL note (verified 2026-07-23): the old `docs.claude.com/...` paths still 301 to these,
> but WebFetch does **not** follow cross-host redirects — always use the URLs above directly.
