...
|--------|-------|-------------|
| `Accept` | `application/vnd.sdmx.data+json;version=1.0.0-wd` | JSON format (recommended). The `version=2.0.0` value seen in older examples returns HTTP 406 Not Acceptable -- verified; `1.0.0-wd` is the version this endpoint currently accepts. |
